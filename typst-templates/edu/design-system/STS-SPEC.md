...
| Layer | 이름 | 다루는 것 | 상태 |
|--|--|--|--|
| **L1** | Question | 한 문제 안 식자 | ✅ v22 완료 |
| **L2** | Page | 여러 문제 모음 + passage 배치 + 헤더/푸터 | 진행 중 |
| **L3** | Chapter | PART 단위 — 챕터 표지, 챕터 사이 빈 페이지 | 미시작 |
| **L4** | Book | 표지/속표지/목차/빠른정답/창고 | 미시작 |

각 Layer는 **룰 + 토큰**으로 정의. preset은 토큰 값만 override.
